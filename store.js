...
loadItems: function() {
  var loadRequest = $.ajax({
    type: 'GET',
    url: "https://listalous.herokuapp.com/lists/swesoc/"
  })
...
var creationRequest = $.ajax({
   type: 'POST',
   url: "http://listalous.herokuapp.com/lists/swesoc/items",
...
var updateRequest = $.ajax({
   type: 'PUT',
   url: "https://listalous.herokuapp.com/lists/swesoc/items/" + itemId,
